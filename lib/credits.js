...
import { USER_TABLE, CREDIT_TRANSACTION_TABLE, STUDY_MATERIAL_TABLE } from "@/configs/schema";
...
export async function getUserCredits(email) {
  ...
  try {
    ...
    // 2. Sum up positive transactions that grant credits (welcome bonus, purchases, admin edits)
